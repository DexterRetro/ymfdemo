        ...
        SubInfo: [
          {
            ...
            Info: [
              ...
              "We are well-placed as an organization to transform our gold mining operations into more Mechanized Medium Scale Mining activities. To this end we would need a Hammer Mill, Crusher and Separator for milling particularly in our Midlands Chapter.",
        ...
        SubInfo: [
          {
            ...
            Info: [
              "• Getting advice and resource material to start self help mining ventures whether at small, medium and/or large scale.",
              "• Have access to participate in Young Miners organised capacity building workshops, seminars and mining Indabas where members can exchange experiences and best practices.",
              "• Members can own mining claims through the assistance of the Foundation.",
              "• Access to partnerships, tribute agreements and increasing mining activities.",
              "• Privilege to hold offices in the Foundation.",
              "• Attending and voting at the Y.I.M.F Annual General Meeting (A.G.M.)",
              "• Receiving Y.I.M.F. publication and contribution to it",
              "• Walk in Consultancy.",
              "• Being involved in the development of Youth EconomicEmpowerment agenda in mining.",
              "• Getting exposed and linked to regional and global mining movements",
              "• Legal advices and representations.",
              "• Representations of disabled miners"
            ]
          }
        ]
      }
